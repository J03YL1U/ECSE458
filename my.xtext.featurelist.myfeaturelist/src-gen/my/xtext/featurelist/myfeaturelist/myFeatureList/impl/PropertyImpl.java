...
public class PropertyImpl extends MinimalEObjectImpl.Container implements Property
{
  ...
  {
    return MyFeatureListPackage.Literals.PROPERTY;
  }
    ...
    if (concept != null && concept.eIsProxy())
    {
      ...
      if (concept != oldConcept)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MyFeatureListPackage.PROPERTY__CONCEPT, oldConcept, concept));
      }
    }
    return concept;
  }
  ...
  public void setConcept(Concept newConcept)
  {
    ...
    concept = newConcept;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyFeatureListPackage.PROPERTY__CONCEPT, oldConcept, concept));
  }
