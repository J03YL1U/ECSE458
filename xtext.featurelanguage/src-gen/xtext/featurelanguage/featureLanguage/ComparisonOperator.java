 ...
 * <!-- end-user-doc -->
 * @see xtext.featurelanguage.featureLanguage.FeatureLanguagePackage#getComparisonOperator()
 * @model
 * @generated
 */
public enum ComparisonOperator implements Enumerator
{
   ...
   * @ordered
   */
  GREATER_THAN_OR_EQUAL(1, "GreaterThanOrEqual", ">="),
   ...
   * @ordered
   */
  LESS_THAN_OR_EQUAL(3, "LessThanOrEqual", "<="),
